...
//	public static final String PARAMETER_API_KEY = "API key";
	 ...
	 */
	public static final String PARAMETER_PATH_TO_AUDIO_FILE = "audio file";
	/**
	 * URI to Cloud Storage Bucket with the audio file to be transcribed.
	 */
	public static final String PARAMETER_REMOTE_URI = "Cloud Storage Bucket URI";
	/**
	 * Sample rate in Hz of the file to be transcribed.
	 */
	public static final String PARAMETER_SAMPLE_RATE = "sample rate (Hz)";
	/**
	 * Language code of the language used in the audio file to be transcribed.
	 */
	public static final String PARAMETER_LANGUAGE = "language code";
	
	public static final String PARAMETER_ENCODING = "encoding"; 
	/**
	 * Whether to apply a profanity filter in the transcription.
	 */
	public static final String PARAMETER_PROFANITY_FILTER = "profanity filter";
	...
	public List<ParameterType> getParameterTypes() {
		...
		ParameterTypeFile audioFile = new ParameterTypeFile(PARAMETER_PATH_TO_AUDIO_FILE, "Audio file to process.", true,
				audioFileExtensions);
		...
		ParameterTypeString remoteURL = new ParameterTypeString(PARAMETER_REMOTE_URI,
		...
		ParameterTypeCategory encoding = new ParameterTypeCategory(PARAMETER_ENCODING,
		...
		ParameterTypeInt sampleRateHertz = new ParameterTypeInt(PARAMETER_SAMPLE_RATE,
		...
		ParameterTypeStringCategory languageCode = new ParameterTypeStringCategory(PARAMETER_LANGUAGE,
		...
		ParameterTypeBoolean profanityFilter = new ParameterTypeBoolean(PARAMETER_PROFANITY_FILTER,
	...
	public void doWork() throws OperatorException {
		...
		String language = this.getParameterAsString(PARAMETER_LANGUAGE);
		String encoding = this.getParameterAsString(PARAMETER_ENCODING);
		int sampleRateHertz = this.getParameterAsInt(PARAMETER_SAMPLE_RATE);
		boolean profanityFilter = this.getParameterAsBoolean(PARAMETER_PROFANITY_FILTER);
		...
		if (this.getParameterAsString(PARAMETER_REQUEST_TYPE).equals("local")) {
			try {
				fileName = this.getParameterAsString(PARAMETER_PATH_TO_AUDIO_FILE);
			...
			try {
				...
				remoteURL = this.getParameterAsString(PARAMETER_REMOTE_URI);
				...
				getLogger().info("Exception in remote file call" + e.getMessage());
				e.printStackTrace();
				throw new OperatorException(e.getMessage());
			}
		} 
			...
			getLogger().info("Error in getting key" + e1.getMessage());
			e1.printStackTrace();
			return;
		}
